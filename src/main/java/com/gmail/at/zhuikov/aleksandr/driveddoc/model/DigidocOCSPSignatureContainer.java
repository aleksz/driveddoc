...
public class DigidocOCSPSignatureContainer {

	private InputStream stream;
	private X509Certificate signCert;
	private KeyStore keyStore;
	private PrivateKey signKey;
	private SignatureContainerDescription description;

	public DigidocOCSPSignatureContainer(InputStream stream,
    ...
    private KeyStore getKeyStore() throws DigiDocException {
    	if (keyStore == null) {
    		keyStore = loadStore(stream, description.getPassword());
    	} 
